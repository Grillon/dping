...
if ( seq_manquantes != "" ) print "liste des sequences perdues : "seq_manquantes
...
if (bp_tr) {
split(bp_tr,bp,"-")
	print "pour rrdtool de "source" vers "dest"_"nom_if"#"debut":"pertes":"bp[1]":"bp[2]
}
else print "pour rrdtool de "source" vers "dest"_"nom_if"#"debut":"pertes
